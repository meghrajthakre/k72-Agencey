...
const BottomLeft = () => {
  return (
    <div className='font-[font1] text-white flex items-center justify-center gap-5'>
      ...
      <div className='border-2 hover:border-[#d3fd50] hover:text-[#d3fd50] h-24 flex items-center px-8 border-white rounded-full uppercase' >
